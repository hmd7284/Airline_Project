...
VALUES
    ...
    ('2023-12-02', 2, 'Success', 450.0),
    ('2023-12-03', 3, 'Success', 2160.0),
    ('2023-12-04', 4, 'Success', 1650.0),
    ('2023-12-05', 5, 'Success', 520.0),
    ('2023-12-06', 6, 'Success', 1590.0),
    ('2023-12-07', 7, 'Success', 750.0),
    ('2023-12-08', 8, 'Success', 2375.0),
    ('2023-12-09', 9, 'Success', 1560.0),
    ('2023-12-10', 10, 'Success', 1675.0),
    ('2023-12-11', 11, 'Success', 1950.0),
    ('2023-12-12', 12, 'Success', 450.0),
    ('2023-12-13', 13, 'Success', 1590.0),
    ('2023-12-14', 14, 'Success', 1650.0),
    ('2023-12-15', 15, 'Success', 1745.0),
    ('2023-12-16', 16, 'Success', 795.0),
    ('2023-12-17', 17, 'Success', 1500.0),
    ('2023-12-18', 18, 'Success', 2475.0),
